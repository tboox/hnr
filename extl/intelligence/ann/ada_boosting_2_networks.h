/* ///////////////////////////////////////////////////////////////////////
 * File:		ada_boosting_2_networks.h		
 *
 * Created:		08.12.27		
 * Updated:		09.06.07
 *
 * Brief:		The ada_boosting_2_networks class - for binary-class problem
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_INTELLIGENCE_ANN_ADA_BOOSTING_2_NETWORKS_H
#define EXTL_INTELLIGENCE_ANN_ADA_BOOSTING_2_NETWORKS_H

/*!\file ada_boosting_2_networks.h
 * \brief ada_boosting_2_networks class
 */
...
#	error ada_boosting_2_networks.h is not supported by the current compiler.
#endif
...
class ada_boosting_2_networks
{
	
	/// \name Types
	/// @{
	public:
		typedef ada_boosting_2_networks												class_type;
	...
	/// @{
	public:
		ada_boosting_2_networks()
			: m_networks()
			, m_foutputs()
			, m_weights()
			, m_validator()
		{
			EXTL_STATIC_ASSERT(en_output_size == 1);
			init();
		}
		ada_boosting_2_networks(class_type const& rhs)
 ...
 */
template<typename_param_k NetWork>
void ada_boosting_2_networks<NetWork>::push_back(network_type const& net)
{
	networks().push_back(net);
	weights().resize(networks().size());
}
template<typename_param_k NetWork>
void ada_boosting_2_networks<NetWork>::swap(class_type& rhs)	
{ 
...
template<typename_param_k NetWork>
void ada_boosting_2_networks<NetWork>::train_network(network_type& net, samples_type& sps, size_type train_n, floats_type const& sps_ws)
{
...
template<typename_param_k NetWork>
void ada_boosting_2_networks<NetWork>::train(samples_type& sps, size_type train_n)
{
...
template<typename_param_k NetWork>
inline void ada_boosting_2_networks<NetWork>::run(sample_type& sp)
{
	index_type i, j;
...
/*template<typename_param_k NetWork>
inline void ada_boosting_2_networks<NetWork>::run(samples_type& sps)
{
	size_type sps_n = sps.size();
	for (index_type i = 0; i < sps_n; ++i)
		run(sps[i]);
...
template<typename_param_k NetWork>
inline typename_type_ret_k ada_boosting_2_networks<NetWork>::
float_type ada_boosting_2_networks<NetWork>::foutput(index_type i) const
{
...
template<typename_param_k NetWork>
inline typename_type_ret_k ada_boosting_2_networks<NetWork>::
bool_type ada_boosting_2_networks<NetWork>::boutput(index_type i) const
{
	EXTL_ASSERT(i < m_foutputs.size());
	return xtl_round45(m_foutputs[i] == 1);	
}
template<typename_param_k NetWork>
void ada_boosting_2_networks<NetWork>::init()
{
	index_type i;
...
/* //////////////////////////////////////////////////////////////////// */
#endif	/* EXTL_INTELLIGENCE_ANN_ADA_BOOSTING_2_NETWORKS_H */
/* //////////////////////////////////////////////////////////////////// */
