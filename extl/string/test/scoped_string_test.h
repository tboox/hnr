/* ///////////////////////////////////////////////////////////////////////
 * File:		scoped_string_test.h		
 *
 * Created:		08.05.29					
 * Updated:		08.05.29	
 *
 * Brief: scoped_string unit-testing
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_STRING_SCOPED_STRING_TEST_H
#define EXTL_STRING_SCOPED_STRING_TEST_H

#ifndef EXTL_STRING_SCOPED_STRING_H
#	error This file must be included of scoped_string.h
#endif
...
EXTL_TEST_NAME_BEGIN_NAMESPACE(scoped_string_test)

/* ///////////////////////////////////////////////////////////////////////
 * Unit-testing 
 */
static int scoped_string_test()
{
	typedef scoped_string char_scoped_string;

	char_scoped_string char_string0;
	char_scoped_string char_string1(_T("char_string"));
	char_scoped_string char_string2(char_string1);
	char_scoped_string char_string3(char_string1, 4);
	char_scoped_string char_string5(_T("char_string"), 4);
	...
	char_scoped_string char_string6(_T("char_string"));
	char_scoped_string char_string7(_T("char"));
	...
	char_scoped_string char_string8(_T("123456789"));
	char_scoped_string char_string9(_T("123456789"));
	char_scoped_string char_string10(_T("987654321"));

	char_scoped_string char_string11(_T("ABCDabcd987654321"));
	...
	/* iterator test */
	char_scoped_string char_string12(_T("123456789"));
	char_scoped_string char_string13(char_string12.begin(), char_string12.end());
	...
	char_scoped_string char_string14(p, p + 9);
	...
	typedef basic_scoped_string<	e_tchar_t
								...
								> char_tiny_scoped_string;
	char_tiny_scoped_string tts(_T("12345"));
...
int scoped_string_test_ret = scoped_string_test();

/* ///////////////////////////////////////////////////////////////////////
 * ::test namespace
 */
EXTL_TEST_NAME_END_NAMESPACE(scoped_string_test)
EXTL_END_NAMESPACE
/* //////////////////////////////////////////////////////////////////// */
#endif /* EXTL_STRING_SCOPED_STRING_TEST_H */
/* //////////////////////////////////////////////////////////////////// */
