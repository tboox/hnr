/* ///////////////////////////////////////////////////////////////////////
 * File:		indirected_net_adjnode_iterator.h		
 *
 * Created:		08.12.04	
 * Updated:		08.12.04
 *
 * Brief:		The indirected_net_adjnode_iterator class
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_CONTAINER_DETAIL_INDIRECTED_NET_ADJNODE_ITERATOR_H
#define EXTL_CONTAINER_DETAIL_INDIRECTED_NET_ADJNODE_ITERATOR_H
...
template<	typename_param_k NodBuf
		...
		>
class const_indirected_net_adjnode_iterator
	: public const_bidirectional_iterator_base	<	const_indirected_net_adjnode_iterator<NodBuf, AdjMtx>
												,	typename_type_k NodBuf::index_type
												,	e_ptrdiff_t
												>
{
	private:
		typedef const_bidirectional_iterator_base	<	const_indirected_net_adjnode_iterator<NodBuf, AdjMtx>
													,	typename_type_k NodBuf::index_type
													,	e_ptrdiff_t
													>									base_type;
	...
	public:
		typedef const_indirected_net_adjnode_iterator											class_type;
	...
	public:
		const_indirected_net_adjnode_iterator() 
			: m_current() 
			, m_pnodes(NULL)
		{}
		const_indirected_net_adjnode_iterator(index_type id, const_rowe_iterator current, nodes_type const& ns, adjmtx_type const& atx) 
			: m_current(current)
			, m_pnodes(&ns)
			, m_padjmtx(&atx)
			, m_id(id)
		...
		const_indirected_net_adjnode_iterator(class_type const& it) 
	...
	public:
		...
		{
			return ((m_id != (*current()).end_id())? (*current()).end_id() 
				: (m_id != (*current()).begin_id()? (*current()).begin_id() : m_id));
		}
...
EXTL_END_NAMESPACE
/* //////////////////////////////////////////////////////////////////// */
#endif	/* EXTL_CONTAINER_DETAIL_INDIRECTED_NET_ADJNODE_ITERATOR_H */
/* //////////////////////////////////////////////////////////////////// */
