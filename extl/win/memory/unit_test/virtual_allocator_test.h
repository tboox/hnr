 ...
 * //////////////////////////////////////////////////////////////////// */
#ifndef EXTL_MEMORY_VIRTUAL_ALLOCATOR_TEST_H
#define EXTL_MEMORY_VIRTUAL_ALLOCATOR_TEST_H

#ifndef EXTL_PLATFORM_WIN_MEMORY_VIRTUAL_ALLOCATOR_H
#	error This file must be included of virtual_allocator.h
#endif
 ...
 */
	...
	template < typename_param_k T, typename_param_k A = virtual_allocator<T> >
#else
	template < typename_param_k T, typename_param_k A >
#endif
struct virtual_allocator_test
{
	virtual_allocator_test()
	{
		virtual_allocator<void> void_allocator;
...
#	ifdef EXTL_TEMPLATE_CLASS_DEFAULT_ARGUMENT_SUPPORT
		virtual_allocator_test< e_uint_t > g_virtual_allocator_test;
#	else
		virtual_allocator_test< e_uint_t, virtual_allocator< e_uint_t > > g_virtual_allocator_test;
#	endif
#endif
...
/* //////////////////////////////////////////////////////////////////// */
#endif /* EXTL_MEMORY_VIRTUAL_ALLOCATOR_TEST_H */
/* //////////////////////////////////////////////////////////////////// */
