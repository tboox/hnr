 ...
 * Updated:		08.04.14
 *
 * Brief: Intel C/C++ compiler traits.
 *
 * [<Home>]
...
#define EXTL_WORKAROUND_INTEL(cmp, ver)	( (__INTEL_COMPILER != 0) && ( (__INTEL_COMPILER) cmp (ver) ) )
 ...
 * wchar_t support
 */
/* VC 7.0 and 7.1支持__wchar_t但与wchar_t不兼容 */
#if defined(_MSC_VER)
#	if _MSC_VER >= 1300
#		ifdef _NATIVE_WCHAR_T_DEFINED
#			define EXTL_NATIVE_WCHAR_T_SUPPORT	/* 原生wchar_t */
#		elif defined(_WCHAR_T_DEFINED)
#			define EXTL_TYPEDEF_WCHAR_T_SUPPORT	/* 由typedef定义的wchar_t */
#		else
 ...
 * from file "extl\string\stack_string.h for traits\is_mem_func_ptr.h"
 */
#pragma warning(disable:1595) 

/* pointless comparison of unsigned integer with zero
 * from file ""extl\memory\basic_pool.h" - EXTL_ASSERT(index >= 0...
 */
#pragma warning(disable:186) 

/* warning #279: controlling expression is constant
 * from EXTL_MESSAGE_ASSERT()
 */
