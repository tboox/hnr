/* ///////////////////////////////////////////////////////////////////////
 * File:		net_in_adjnode_iterator.h		
 *
 * Created:		08.12.04	
 * Updated:		08.12.04
 *
 * Brief:		The net_in_adjnode_iterator class
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_CONTAINER_DETAIL_NET_IN_ADJNODE_ITERATOR_H
#define EXTL_CONTAINER_DETAIL_NET_IN_ADJNODE_ITERATOR_H
...
template<	typename_param_k NodBuf
		...
		>
class const_net_in_adjnode_iterator
	: public const_bidirectional_iterator_base	<	const_net_in_adjnode_iterator<NodBuf, AdjMtx>
												,	typename_type_k NodBuf::index_type
												,	e_ptrdiff_t
												>
{
	private:
		typedef const_bidirectional_iterator_base	<	const_net_in_adjnode_iterator<NodBuf, AdjMtx>
													,	typename_type_k NodBuf::index_type
													,	e_ptrdiff_t
													>									base_type;
		...
		typedef typename_type_k adjmtx_type::const_cole_iterator						const_cole_iterator;

	public:
		typedef const_net_in_adjnode_iterator											class_type;
	...
	public:
		const_net_in_adjnode_iterator() 
			...
			, m_pnodes(NULL)
		{}
		const_net_in_adjnode_iterator(index_type id, const_cole_iterator current, nodes_type const& ns, adjmtx_type const& atx) 
			: m_current(current)
			, m_pnodes(&ns)
			, m_padjmtx(&atx)
			, m_id(id)
		{
			for (; m_current != adjmtx().cole_end(m_id) && (*m_current).is_empty(); ++m_current);
		}	
		const_net_in_adjnode_iterator(class_type const& it) 
	...
	public:	
		const_cole_iterator 		current() const				{ return m_current;										}
	...
	private:
		...
		void						next()
		{
			for (; ++m_current != adjmtx().cole_end(m_id) && (*m_current).is_empty(); );
		}
		void						prev()
		{
			for (; --m_current != adjmtx().cole_begin(m_id) && (*m_current).is_empty(); );
			if (m_current == adjmtx().cole_begin(m_id) && (*m_current).is_empty())
				m_current = adjmtx().cole_end(m_id);
...
EXTL_END_NAMESPACE
/* //////////////////////////////////////////////////////////////////// */
#endif	/* EXTL_CONTAINER_DETAIL_NET_IN_ADJNODE_ITERATOR_H */
/* //////////////////////////////////////////////////////////////////// */
