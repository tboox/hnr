 ...
 * Updated:		08.04.14
 *
 * Brief: Codeplay VectorC C++ compiler traits.
 *
 * [<Home>]
...
#	error This file has been erroneously included for a compiler other than Codeplay VectorC C/C++ 
#endif 
...
#define EXTL_WORKAROUND_VECTORC(cmp, ver)	( (__VECTORC != 0) && ( (__VECTORC) cmp (ver) ) )
...
/* Template specialization within template classes support(not testing) */
