...
#	error This file has been erroneously included for a compiler other than GNU C/C++
#endif 
...
#define EXTL_WORKAROUND_GCC(cmp, ver)		( (__GNUC__ != 0) && ( (__GNUC__) cmp (ver) ) )
#define EXTL_WORKAROUND_GCC_MINOR(cmp, ver)	( (__GNUC_MINOR__ != 0) && ( (__GNUC_MINOR__) cmp (ver) ) )
/* ///////////////////////////////////////////////////////////////////////
 * Interger 
 */
 ...
 */
#if !(__GNUC__ == 3 && ((__GNUC_MINOR__ == 1) || (__GNUC_MINOR__ == 2)))	// exclude gcc 3.1 3.2
 ...
 */
#define EXTL_CURRENT_FUNCTION	__PRETTY_FUNCTION__
...
#else 
#	define EXTL_CUSTOM_C_INLINE        __inline__
#endif 
 ...
 */
#if __GNUC__ > 3 || ( __GNUC__ == 3 && __GNUC_MINOR__ >= 1 ) /* version 3.1 */
