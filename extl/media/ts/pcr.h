 ...
 * Updated:		09.03.04
 *
 * Brief:		the pcr class - the program clock reference
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_MEDIA_TS_PCR_H
#define EXTL_MEDIA_TS_PCR_H

/*!\file pcr.h
 * \brief the pcr class - program clock reference
 */
#ifndef __cplusplus
#	error pcr.h need be supported by c++.
#endif
...
class pcr
{
	...
	public:
		/// the pcr size
		size_type			size() const		{ return en_pcr_size;			}

		/// return the offset at the packet
		size_type			offset() const		{ return (adaptation().offset() + adaptation().header().size());	}

		///  return \true if exists pcr
		bool_type			exists() const		{ return (1 == adaptation().header().pcr_flag());	}
