/* ///////////////////////////////////////////////////////////////////////
 * File:		sparse_matrix_rowe_iterator.h		
 *
 * Created:		08.12.08	
 * Updated:		08.12.08
 *
 * Brief:		The Sparse Matrix Row Entry Iterator
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_CONTAINER_DETAIL_SPARSE_MATRIX_ROWE_ITERATOR_H
#define EXTL_CONTAINER_DETAIL_SPARSE_MATRIX_ROWE_ITERATOR_H
...
template<	typename_param_k Val
		...
		>
class const_sparse_matrix_rowe_iterator
	: public const_bidirectional_iterator_base	<	const_sparse_matrix_rowe_iterator<Val, Nod>
												,	Val
												,	e_ptrdiff_t
												>
{
	protected:
		typedef const_bidirectional_iterator_base	<	const_sparse_matrix_rowe_iterator<Val, Nod>
													,	Val
													,	e_ptrdiff_t
													>									base_type;
	...
	public:
		typedef const_sparse_matrix_rowe_iterator										class_type;
	...
	public:
		const_sparse_matrix_rowe_iterator() 
			: m_current(NULL) 
		{}
		const_sparse_matrix_rowe_iterator(const_node_pointer cur) 
			: m_current(cur) 
		{}	
		const_sparse_matrix_rowe_iterator(class_type const& it) 
...
// sparse_matrix_rowe_iterator can be converted to const_sparse_matrix_rowe_iterator implicitly
template<	typename_param_k Val
		,	typename_param_k Nod
        >
class sparse_matrix_rowe_iterator
	: public bidirectional_iterator_base<	sparse_matrix_rowe_iterator<Val, Nod>
										,	const_sparse_matrix_rowe_iterator<Val, Nod>
										,	Val
										,	e_ptrdiff_t
										>
{
	private:
		typedef bidirectional_iterator_base	<	sparse_matrix_rowe_iterator<Val, Nod>
											,	const_sparse_matrix_rowe_iterator<Val, Nod>
											,	Val
											,	e_ptrdiff_t
											>											base_type;
		typedef const_sparse_matrix_rowe_iterator<Val, Nod>								const_iterator_type;
		typedef base_type																iterator_base_type;
	...
	public:
		typedef sparse_matrix_rowe_iterator												class_type;
		typedef typename_type_k iterator_base_type::iterator_category					iterator_category;
		typedef typename_type_k iterator_base_type::value_type							value_type;
		typedef typename_type_k iterator_base_type::reference							reference;
		typedef typename_type_k iterator_base_type::const_reference						const_reference;
	...
	public:
		sparse_matrix_rowe_iterator() 
			: base_type() 
		{}
		explicit_k sparse_matrix_rowe_iterator(const_node_pointer cur) 
			: base_type(const_iterator_type(cur)) 
		{}	
		sparse_matrix_rowe_iterator(class_type const& it) 
			: base_type(it)
		{}
		// const_sparse_matrix_rowe_iterator can be explicitly converted to sparse_matrix_rowe_iterator
		// because this is an empty member class
		explicit_k sparse_matrix_rowe_iterator(base_type const& it) 
			: base_type(it) 
		{}
...
EXTL_END_NAMESPACE
/* //////////////////////////////////////////////////////////////////// */
#endif	/* EXTL_CONTAINER_DETAIL_SPARSE_MATRIX_ROWE_ITERATOR_H */
/* //////////////////////////////////////////////////////////////////// */
