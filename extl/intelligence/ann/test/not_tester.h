 ...
 * //////////////////////////////////////////////////////////////////// */
#ifndef EXTL_INTELLIGENCE_ANN_TEST_NOT_TESTER_H
#define EXTL_INTELLIGENCE_ANN_TEST_NOT_TESTER_H
...
struct not_tester
{
	...
	public:
		void test(network_type& network, size_type n)
		{
			...
			sp.binput("00");
			network.run(sp);
			EXTL_TEST_TRACE(_T("input:%d %d output:%d %d foutput:%f %f"), sp.get_binput(0), sp.get_binput(1), sp.get_boutput(0), sp.get_boutput(1), network.foutput(0), network.foutput(1));
...
/* //////////////////////////////////////////////////////////////////// */
#endif /* EXTL_INTELLIGENCE_ANN_TEST_NOT_TESTER_H */
/* //////////////////////////////////////////////////////////////////// */
