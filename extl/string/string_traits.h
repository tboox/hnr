 ...
 * Updated:		08.04.14	
 *
 * Brief: string_traits class 
 *
 * Note: Make full use of string_traits class, not std_char_traits
 *
 * [<Home>]
 * Copyright (c) 2008-2020, Waruqi All rights reserved.
 * //////////////////////////////////////////////////////////////////// */

#ifndef EXTL_STRING_STRING_TRAITS_H
#define EXTL_STRING_STRING_TRAITS_H
...
#ifndef __cplusplus
#	error string_traits.h need be supported by c++.
#endif
...
{
	public:
		typedef string_traits<C, T>										class_type;
...
inline e_char_t const* string_traits<e_char_t>::copy(e_char_t* dest, e_char_t const* src)
{
	return std_strcpy_a(dest, src);
}

EXTL_TEMPLATE_SPECIALISATION
inline e_wchar_t const* string_traits<e_wchar_t>::copy(e_wchar_t* dest, e_wchar_t const* src)
{
	return std_strcpy_w(dest, src);
}

EXTL_TEMPLATE_SPECIALISATION
inline e_int_t string_traits<e_char_t>::compare(e_char_t const* lhs, e_char_t const* rhs)
{
	return std_strcmp_a(lhs, rhs);
}
EXTL_TEMPLATE_SPECIALISATION
inline e_int_t string_traits<e_wchar_t>::compare(e_wchar_t const* lhs, e_wchar_t const* rhs)
{
...
/* //////////////////////////////////////////////////////////////////// */
#endif /* EXTL_STRING_STRING_TRAITS_H */
/* //////////////////////////////////////////////////////////////////// */
